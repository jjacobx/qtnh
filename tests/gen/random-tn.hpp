...
namespace gen {
  ...
  const tn_validation v7 {
    ...
    std::vector<bond_info> {
      ...
      bond_info { 1, 2, {{ 2, 2 }, { 1, 1 }}}
    }, 

    tensor_info {{ 2, 2 }, { -1.94+0.89i, -0.11+0.64i, -0.37-0.57i,  0.41-0.78i }}
  };
  ...
  const tn_validation v8 {
    ...
    std::vector<bond_info> {
      ...
      bond_info { 1, 2, {{ 1, 3 }, { 0, 0 }, { 3, 2 }}}
    }, 

    tensor_info {{ 2, 2 }, {  1.46-2.44i, -2.39+0.27i, -1.96+1.25i,  0.54-0.11i }}
  };
  ...
  const tn_validation v10 {
    ...
    std::vector<bond_info> {
      ...
      bond_info { 1, 2, {{ 2, 0 }, { 0, 1 }}}
    }, 

    tensor_info {{ 2, 2, 2 }, {  0.85+0.16i, -1.88-0.17i,  1.50+2.29i, -0.62-2.34i,  0.59+0.81i, -0.31-0.98i, -2.94-0.48i,  2.29+0.76i }}
  };
